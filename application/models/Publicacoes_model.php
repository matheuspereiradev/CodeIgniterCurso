...
//variaveis publicas dos campos
    ...
    public function suas_publicacoes($id) {
        //aqui é um join a diferença o select pro get é que o seelect é em muitas tabelas e o get é em uma unica
        $this->db->select('postagens.id as idpost, postagens.titulo as titulo, postagens.subtitulo as subtitulo, postagens.user as user,
			postagens.data as data, postagens.categoria');
        $this->db->from('postagens');
        $this->db->join('categoria', 'postagens.categoria=categoria.id'); //aqui faz o join juntando com a postagem colocando o nome da tabela depois o where
        $this->db->where('postagens.user = ' . $id);
    ...
    public function editar($id, $categoria, $titulo, $subtitulo, $conteudo, $data, $user) {
        $dados['id'] = $id;
        $dados['categoria'] = $categoria;
        $dados['titulo'] = $titulo;
        $dados['subtitulo'] = $subtitulo;
